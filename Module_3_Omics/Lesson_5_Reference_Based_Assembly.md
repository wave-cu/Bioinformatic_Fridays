# Lesson 5: Reference-Based Assembly (Reference-Guided)
...
1. Assemble the full genome is the de-novo assembly fails?
...
We will use the cleaned fastq from Lesson 4, the ones we mapped to cassava (host) in the previous lesson. These are the same reads we used for de novo assembly, but now we will map them to a combined ACMV reference.:

- `Training/long_reads/denovo/clean/barcode57_clean.fastq`
- `Training/long_reads/denovo/clean/barcode58_clean.fastq` # assuming you did the same for barcode58 in Lesson 4, if not just focus on barcode57 for this lesson.
...
## 5. Prepare the Combined ACMV Reference
...
## 6. Map Long Reads to ACMV DNA-A + DNA-B
...
## 7. Evaluate Mapping Quality and Coverage
...
Generate consensus FASTA (Rapid way).
